...
const Note = () => {
  ...
  return (
    <div className="main-note">
      <ShowNote showNote={showNote} toggleNote={toggleNote}>
      </ShowNote>
      ...
      <div className="note-container">
        <div className="note-components">
          <div className="note-components-left">
            ...
            <p style={{ color: "beige", fontFamily: "Bebas Neue" }}>
              "Life is a journey with its fair share of ups and downs, twists
              and turns. It's not always about the destination, but the
              experiences along the way. Challenges may arise, but our
              responses to them define the chapters of our story. Embrace the
              moments, learn from the hardships, and cherish the joys, for in
              the end, it's not the years in your life that count, but the
              life in your years."
            </p>
